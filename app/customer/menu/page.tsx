...
import { ArrowLeftIcon, ArrowRightIcon, ArrowUpRightIcon, CakeSliceIcon, ChefHatIcon, ChevronRightIcon, CoffeeIcon, UtensilsIcon } from "lucide-react"
  ...
  return (
    <main className="flex flex-1 flex-col bg-muted/20">
      <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-8 p-4 md:p-6 lg:p-8">
        ...
        <section className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">{visibleItems.map((item) => <MenuCard key={item.name} item={item} />)}</section>
